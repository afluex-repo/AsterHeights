(function($) {
	...
	if ($('.specialize-section-two .image-carousel').length && $('.specialize-section-two .thuAsterHeight-carousel').length) {

		var $sync1 = $(".specialize-section-two .image-carousel"),
			$sync2 = $(".specialize-section-two .thuAsterHeight-carousel"),
			flag = false,
			duration = 500;
