...
namespace AsterHeight.Models
{
    public class Plot : Common
    {
        ...
        public List<PlotUtr> lstUtr { get; set; }
        ...
        public DataSet GetPaymentPlanListEdit()
        {
            SqlParameter[] para = { new SqlParameter("@PK_PLanID", null) };
            DataSet ds = Connection.ExecuteQuery("GetPaymentPlanNew", para);
            return ds;
        }
        ...
        public DataSet GetPaymentModeListforconvert()
        {
            SqlParameter[] para =
                            {
                                new SqlParameter("@PK_paymentID",PK_PaymentId)
                            };
            DataSet ds = Connection.ExecuteQuery("GetPaymentModeList", para);
            return ds;
        }
        ...
        public DateTime Hold_From { get; set; }
        public DateTime Hold_To { get; set; }
            ...
            SqlParameter[] para =
                            {
                                        ...
                                        new SqlParameter("@FK_BlockID" , BlockID),
                                        new SqlParameter("@PlotNumber"  , PlotNumber),
                                        new SqlParameter("@HoldFrom" ,Hold_From),
                                        new SqlParameter("@HoldTo" ,Hold_To),
        ...
        public DataSet ConvertToBooking()
        {
            SqlParameter[] para =
                            {
                                        new SqlParameter("@PK_PlotHoldID",PK_PlotHoldID),
                                        new SqlParameter("@ModifyBy",AddedBy)

                            };
            DataSet ds = Connection.ExecuteQuery("ConvertToBooking", para);
            return ds;
        }
        public DataSet PlotUnHold()
        {
            SqlParameter[] para =
                            {
                                        new SqlParameter("@PK_PlotHoldID ",PK_PlotHoldID),
            ...
            DataSet ds = Connection.ExecuteQuery("PlotUnHold", para);
            return ds;
        }
        #endregion
        ...
        public DataSet ListNew()
        {
            ...
            DataSet ds = Connection.ExecuteQuery("GetPlotAllotmentReportNew", para);
            return ds;
        }
        #endregion
        ...
        public DataSet GetPaymentDetailList()
        {
            SqlParameter[] para =
                            {
                                 new SqlParameter("@PK_BookingId",PK_BookingId),
            ...
            DataSet ds = Connection.ExecuteQuery("GetBookingDetailforEdit", para);
            return ds;
        }
        ...
        public List<Testing> myList { get; set; }
        #endregion
        ...
        public DataSet SaveConvertBooking()
        {
            SqlParameter[] para =
                            {
                                        new SqlParameter("@CustomerId ",CustomerID),
            ...
            DataSet ds = Connection.ExecuteQuery("SavePlotByConvertAdmin", para);
            return ds;
        }
        public DataSet SavePlotRegistrationByAdmin()
        {
            SqlParameter[] para =
                            {
                                        new SqlParameter("@Fk_PlotId ",PlotID),
            ...
            DataSet ds = Connection.ExecuteQuery("PlotRegistrationByAdmin", para);
            return ds;
        }
        public DataSet ServerSideDemo()
        {
            SqlParameter[] para = { new SqlParameter("@pageSize", pageSize),
                                      new SqlParameter("@page", page),
                                      new SqlParameter("@sortColumnDir", sortColumnDir),
                                      new SqlParameter("@sortColumn", sortColumn)
                                  };

            DataSet ds = Connection.ExecuteQuery("ServerSideDemo", para);
            return ds;
        }
        ...
        public DataSet UpdateBookingDetail()
        {
            SqlParameter[] para =
                            {
                                        new SqlParameter("@PK_BookingDetailsId ",PK_BookingDetailsId),
            ...
            DataSet ds = Connection.ExecuteQuery("UpdateBookingDetail", para);
            return ds;
        }
    }
